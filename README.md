...
a simple google search doesn't find you versions older than 0.3z r2 and most of those versions used to be lost media until now. 

There are actually a lot of vc-mp versions each made by different people, with different playstyle and features we had a 0.3 server where we used to play regularly as we found it very fun. you often find features from old vc-mp versions that are removed today, they might be really worth checking it out if you like vcmp.
